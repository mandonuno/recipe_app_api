...
def sample_tag(user, name='Lunch'):
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        ...
        tag_2 = sample_tag(user=self.user, name='Breakfast')
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient_1 = sample_ingredient(user=self.user, name='Tuna')
        ingredient_2 = sample_ingredient(user=self.user, name='Chile Pepper')
